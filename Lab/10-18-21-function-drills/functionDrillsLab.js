...
let nameGreeting = nameCheck("Natalie");
...
console.log("New Contestants Array: " + theEliminator(contestants, loser));
...
function chocolateFrogs(gold) {
	chocFrog = 3;
	return Math.floor(gold / chocFrog);
}
let totalFrogs = chocolateFrogs(6);
