...
/*  
    ...
    customerIdId. Additionally, set up a property
    ...
    'The order for customerId [customerIdID] is
    now [STATUS].'
    Where customerIdID and STATUS reference the values
...
class Ticket {
  ...
  updateStatus(newStatus){
    ...
    console.log(`The order for customerId ${this.customerId} is now ${this.status}.`)
  }
}
