// this function uses the utils controller file
...
const speakerData = [{
  ...
  // selects main from html
const main = document.querySelector('main')

function displayData() {
    console.log(speakerData)
    // loops through speaker data array and assigns varirable through each looping session
...
// runs function as soon as webpage is loaded
displayData()